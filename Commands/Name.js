...
module.exports.run = async(client, message, args, embed) => {
    ...
    if (yaş < 14) return message.channel.send(embed.setDescription(`İsmini değiştirdiğin yaşı 14'ten küçük olamaz`)).sil(7)
    if (yaş > 25) return message.channel.send(embed.setDescription(`İsmini değiştirdiğin üyenin yaşı 25'ten büyük olamaz.`)).sil(7)
