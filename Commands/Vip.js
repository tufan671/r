...
if (member.id === message.author.id) return message.channel.send(embed.setDescription(`${message.member}, Kendine ${message.guild.roles.cache.get(ayar.roles.vipRole)} rolü veremezsin!`)).sil(7)
